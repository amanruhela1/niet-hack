const machinesList = document.querySelector("#volunteersCurrent-list");
...
function searchMachines() {
  ...
  machinesList.querySelectorAll("tr").forEach(tr => {
    ...
    const address = tr.querySelector("td:nth-child(4)").textContent.trim().toLowerCase();
    const description = tr.querySelector("td:nth-child(5)").textContent.trim().toLowerCase();
